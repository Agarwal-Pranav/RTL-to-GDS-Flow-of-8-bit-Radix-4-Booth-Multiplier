create_rc_corner -name rc_worst -qx_tech_file {/storage/MTP244102412/counter_layout/inputs/qrcTechFile}
create_rc_corner -name rc_best -qx_tech_file {/storage/MTP244102412/counter_layout/inputs/qrcTechFile}
